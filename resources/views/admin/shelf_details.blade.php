...
<li class="active"><a href="{{ url('admin/shelf-list') }}"><i class="fas fa-book" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Shelf List</span></li>
...
<li class=""><a href="{{ url('admin/log-out') }}"><i class="fas fa-sign-out-alt" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Log out</span></a></li>
    ...
    <div style="padding-left:280px;padding-top:30px">
    <h2 style="margin-top:-50px; padding-top:110px; padding-left:50px; padding-bottom:50px">Shelf ID : {{ $row->Shelf_ID }}</h2>
    <h3 style="margin-top:-50px; padding-left:20px; padding-bottom:50px">Shelf Location : {{ $row->Shelf_Location }}</h3>
    </div>
    @endforeach
    <div class="container">
