...
<li class="active"><a href="{{ url('admin/remove-student') }}"><i class="fas fa-trash" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Remove Student</span></li>
...
<li class=""><a href="{{ url('admin/log-out') }}"><i class="fas fa-sign-out-alt" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Log out</span></a></li>
    ...
    <div class="container">
    <h1 style="margin-top:-50px; padding-left:320px; padding-bottom:50px">Remove Student</h1>
