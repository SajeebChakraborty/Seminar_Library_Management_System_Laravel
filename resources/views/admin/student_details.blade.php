...
<li class=""><a href="{{ url('admin/log-out') }}"><i class="fas fa-sign-out-alt" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Log out</span></a></li>
    ...
    <img src="{{ asset($row->Image) }}" alt="" style="width:100px; height:100px; margin-left:120px; border-radius:50%;margin-bottom:50px">
    <h2 style="margin-top:-50px; padding-top:20px; padding-bottom:50px">Name : {{ $row->Name }}</h2>
    <h3 style="margin-top:-50px; padding-left:20px; padding-bottom:50px">Student ID : {{ $row->Student_ID }}</h3>
    </div>
    @endforeach
    <div class="container">
