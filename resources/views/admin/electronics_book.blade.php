...
<li ><a href="{{ url('admin/book-order') }}"><i class="fas fa-book" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Book Order</span></li>
...
<li class=""><a href="{{ url('admin/log-out') }}"><i class="fas fa-sign-out-alt" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Log out</span></a></li>
    ...
    <h1 style="margin-top:-50px; padding-left:320px; padding-bottom:50px">Electronics Book</h1>
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <?php
            ...
            <td>{{ $count }}</td>
                ...
                <td>
                <a href="{{ url('admin/book/details/'.$row->id) }}" class="btn btn-primary">Details</a>
