...
<li >
          <a href="#" class="shelf-btn active"><i class="far fa-edit" style="margin-left: -10px;font-size:13px;"></i>&nbsp;&nbsp;&nbsp;Shelf Management
            <span class="fas fa-caret-down fourth"></span>
          </a>
          <ul class="shelf-show">
<li class="active"><a href="{{ url('admin/add-shelf') }}">Add New Shelf</a></li>
...
<li class=""><a href="{{ url('admin/log-out') }}"><i class="fas fa-sign-out-alt" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Log out</span></a></li>
    ...
    <div class="content" style="margin-left:100px;margin-top:150px;padding:50px 50px 50px 50px;width:50%; text-align:left; border: 2px solid blue; border-radius:25px">
