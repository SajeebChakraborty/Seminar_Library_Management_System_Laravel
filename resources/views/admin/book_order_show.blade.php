...
<li class="active"><a href="{{ url('admin/book-order') }}"><i class="fas fa-book" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Book Order</span></li>
...
<li class=""><a href="{{ url('admin/log-out') }}"><i class="fas fa-sign-out-alt" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Log out</span></a></li>
    ...
    <h1 style="margin-top:-50px; padding-left:320px; padding-bottom:50px">Book Order</h1>


    <a href="{{ url('/admin/add-order') }}" class="btn btn-primary" style="margin-left:880px; margin-top:-100px;">Add New Order</a>
