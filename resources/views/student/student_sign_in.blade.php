...
<a href="{{ url('/admin') }}" class="btn btn-danger" style="margin-left:1140px; margin-top:14px;">Go to Admin Panel</a>
    ...
    <div id="wrapper">
        ...
        <div class="login">
            ...
            <div class="loginBox">
                <form method="post" action="{{ url('/student/sign-in/process') }}">
            ...
            <br>
            <div class="footer">
                <center> <a href="{{ url('/student/signup') }}">Create New Account</a></center>  
            </div>
            <div class="forgottenPasswoard"> 
                <span><a href="{{ url('/student/forget-password') }}">Forgotten Password?</a></span>
            </div>
        </div>
        <div class="side">
