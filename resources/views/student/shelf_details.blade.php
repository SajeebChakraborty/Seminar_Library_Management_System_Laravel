...
<li class="active"><a href="{{ url('student/shelf-list') }}"><i class="fas fa-book" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Shelf List</span>
...
<li class=""><a href="{{ url('student/log-out') }}"><i class="fas fa-sign-out-alt" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;&nbsp;Log out</span></a></li>
    ...
    <div style="padding-left:280px;padding-top:20px">
    <h2 style="margin-top:-50px; padding-top:0px; padding-left:50px; padding-bottom:50px">Shelf ID : {{ $row->Shelf_ID }}</h2>
