...
<li class="active"><a href="{{ url('student/my-submission') }}"><i class="fas fa-book" style="margin-left: -10px; font-size:15px;"></i>&nbsp;&nbsp;My Submission</span></li>
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <?php
            ...
            <?php
              ...
              $book_count_mode=DB::table('books')->where('Book_ID',$row->Book_ID)
              ->count();
            ...
            <td>{{ $count }}</td>
                ...
                <?php
                    ...
                    $book_info=DB::table('books')->where('Book_ID',$row->Book_ID)
                    ->first();
